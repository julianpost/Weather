...
class RangeSlider: UIControl {
    @IBInspectable var minimumValue: Int = 30 {
        willSet(newValue) {
    ...
    @IBInspectable var maximumValue: Int = 110 {
        willSet(newValue) {
    ...
    @IBInspectable var lowerValue: Int = 32 {
        didSet {
    ...
    @IBInspectable var upperValue: Int = 86 {
        didSet {
    ...
    var gapBetweenThumbs: Int {
        return 1 * Int(thumbWidth) * (maximumValue - minimumValue) / Int(bounds.width)
    }
    ...
    func positionForValue(_ value: Int) -> Int {
        return Int(bounds.width - thumbWidth) * (value - minimumValue) /
            (maximumValue - minimumValue) + Int(thumbWidth/2.0)
    }
    
    func boundValue(_ value: Int, toLowerValue lowerValue: Int, upperValue: Int) -> Int {
    ...
    override func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        let deltaLocation = Int(location.x - previouslocation.x)
        let deltaValue = (maximumValue - minimumValue) * deltaLocation / Int(bounds.width - bounds.height)
